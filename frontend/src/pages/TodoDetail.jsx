          ...
          <div className="detail-card">
            ...
            <div className="detail-card__fields">
              <div className="detail-field">
                ...
                <span className="detail-field__value detail-field__value--mono">{todo.id}</span>
              </div>

              <div className="detail-field">
                <span className="detail-field__label">Description</span>
                <span className="detail-field__value">
                  {todo.description || <em className="detail-field__empty">No description</em>}
                </span>
              </div>

              <div className="detail-field">
                <span className="detail-field__label">Priority</span>
                <span className="detail-field__value"><PriorityBadge priority={todo.priority} /></span>
              </div>

              <div className="detail-field">
                <span className="detail-field__label">Due Date</span>
                <span className={`detail-field__value ${isOverdue ? 'detail-field__value--overdue' : ''}`}>
              ...
              <div className="detail-field">
                ...
                <span className="detail-field__value">{formatDate(todo.createdAt)}</span>
              </div>

              <div className="detail-field">
                <span className="detail-field__label">Updated At</span>
                <span className="detail-field__value">{formatDate(todo.updatedAt)}</span>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="modal-backdrop" role="dialog" aria-modal="true" aria-labelledby="confirm-del-title">
          <div className="modal modal--sm">
            <div className="modal__header">
              <h2 id="confirm-del-title" className="modal__title">🗑️ Delete Todo?</h2>
            </div>
